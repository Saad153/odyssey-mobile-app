...
const LoginComponent = () => {
  ...
  return (
    <View>
      ...
      {!invalid && (
        <Text style={styles.gretTxt}>Enter your Email & Password to Login</Text>
      )}
      {invalid && !load && (
        <Text style={styles.redTxt}>Wrong Email or Password!</Text>
      )}
      ...
      >
        ...
        >
          <Text style={styles.btnText}>
            {!load ? "Continue" : <ActivityIndicator color={"white"} />}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
